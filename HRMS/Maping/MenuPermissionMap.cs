...
namespace HRMS.Maping
{
    public class MenuPermissionMap : EntityTypeConfiguration<MenuPermission> 
    {
        public MenuPermissionMap()
        {
             ...
             HasOptional(c => c.Menu_MenuId).WithMany(o => o.MenuPermission_MenuIds).HasForeignKey(o => o.MenuId).WillCascadeOnDelete(true);
             HasRequired(c => c.Role_RoleId).WithMany(o => o.MenuPermission_RoleIds).HasForeignKey(o => o.RoleId).WillCascadeOnDelete(true);
             HasOptional(c => c.User_UserId).WithMany(o => o.MenuPermission_UserIds).HasForeignKey(o => o.UserId).WillCascadeOnDelete(true);
